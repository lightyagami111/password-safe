    ...
    public static void copySelectionToClipboard(TableView<?> table) {
        ...
        for (TablePosition position : positionList) {
            ...
            if (observableValue == null) {
                ...
                text = ((SimpleStringProperty) observableValue).get();

            } else if (observableValue instanceof SimpleLongProperty) {

                text = numberFormatter.format(((SimpleLongProperty) observableValue).get());

            } else if (observableValue instanceof ObjectProperty) {

                text = ((ObjectProperty) observableValue).asString().get();
